 ...
 */
public class DashPathEffectView extends View implements View.OnClickListener {
    ...
    public DashPathEffectView(Context context, AttributeSet attrs) {
        ...
        mAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                ...
                Log.d("DashPathEffectView", "fraction:" + fraction);

                Log.d("DashPathEffectView", "fraction*length:" + (fraction * length));
...
//        mAnimator.start();
        ...
        mEffect = new DashPathEffect(new float[]{mPathMeasure.getLength(), mPathMeasure.getLength()}, xxx);
        mPaint.setPathEffect(mEffect);
        invalidate();
